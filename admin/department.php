                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 col-lg-6">
                                                                    <div class="form-group">
                                                                        <label for="email2">Department Short Form</label>
                                                                        <input type="text" class="form-control" id="department_name" name="department_name" placeholder="Department Short Form" />
                                                                        <span class="error" style="color:red;"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 col-lg-6">
                                                                    <div class="form-group">
                                                                        <label for="email2">Department Full Form</label>
                                                                        <input type="text" class="form-control" id="department_full_form" name="department_full_form" placeholder="Department Full Form" />
                                                                        <span class="error" style="color:red;"></span>
                                                                    </div>
                                                                </div>
                                                            </div>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $("form#department_form").submit(function(e) {
                        ...
                        var full = $('#department_full_form').val();
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if (response == 'success') {
                                        ...
                                        $('#message').html("<h4 style='color:green; font-weight:bold;text-align:center;'>Department Added Successfully</h4>")
                                        ...
                                        $('#message').html("<h4 style='color:green; font-weight:bold;text-align:center;'>Department Updated Successfully</h4>")
